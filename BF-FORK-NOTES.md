# Business Forge — openclaw insurance fork

This repo is an insurance fork of [openclaw/openclaw](https://github.com/openclaw/openclaw) per the Q13 fork-as-insurance strategy in `H:\task-files\bf-product-price-plans.md`.
...
**Manual sync:** Run `gh repo sync businessforge/openclaw-fork` from a CLI authenticated with `workflow` scope.
